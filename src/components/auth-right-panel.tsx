      ...
      <div className="relative z-10 flex flex-col items-center gap-10">
        ...
        <div className="grid w-full max-w-xs gap-5">
          <FeatureItem
            ...
            title="Tournaments"
            description="Organize and join competitive events"
          />
          <FeatureItem
            icon={
              <path
            ...
            title="Player Stats"
            description="Track wins, losses, and performance"
          />
          <FeatureItem
            icon={
              <path
            ...
            description="Leaderboards across skill levels"
          />
          <FeatureItem
            icon={
              <>
            ...
            description="Members, schedules, and finances"
          />
          <FeatureItem
            icon={
              <path
            ...
            title="Court Queuing"
            description="Fair play rotation and wait lists"
          />
          <FeatureItem
            icon={
              <path
            ...
            title="Find Coaches & Partners"
            description="Book training sessions with varied partners"
          />
          <FeatureItem
            icon={
              <path
            ...
            description="Manage or play across multiple clubs"
          />
        </div>
      </div>
    </div>
